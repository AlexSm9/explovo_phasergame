...
var MusicButton = function(game, music, volume, x, y) {
   this.game = game;
   this.music = music;
   this.volume = volume;
...
MusicButton.prototype.muteMusic = function() {
   ...
   isMute ? (isMute = false, this.music.volume = this.volume, this.musicButton.setFrames('music-button-on2', 'music-button-on')) : (isMute = true, this.music.volume = 0, this.musicButton.setFrames('music-button-off2', 'music-button-off'));
};